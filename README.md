...
8. Export the readable Word report document:
...
`artifacts\reports\documents\bucad_report_summary.docx` for review, archiving,
and defense preparation. The project now treats Word DOCX as the formal report
handoff format and does not generate PDF by default.
