...
| Objective | DenseNet Weight | AUC | Threshold | Sensitivity | Precision | F1-Score | Specificity | Accuracy | Youden J |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
| Rank | DenseNet Weight | AUC | Best Threshold | Sensitivity | Precision | F1-Score | Specificity | Accuracy | Youden J |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
