...
| 模型 | Fold | AUC | Sensitivity | Specificity | Accuracy | 最佳轮次 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
...
| 方案 | AUC | 阈值 | Sensitivity | Specificity | Accuracy | 混淆矩阵 |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| ConvNeXt-Small fold1 crop-sweep | 0.8991 | 0.50 | 0.7857 | 0.8673 | 0.8408 | TN 379 / FP 58 / FN 45 / TP 165 |
| ConvNeXt-Small fold1 强正则 crop-sweep | 0.8759 | 0.50 | 0.7714 | 0.8650 | 0.8346 | TN 378 / FP 59 / FN 48 / TP 162 |
| ConvNeXt-Small 五折 crop-sweep | 0.9040 | 0.50 | 0.8190 | 0.8535 | 0.8423 | TN 373 / FP 64 / FN 38 / TP 172 |
| ConvNeXt-Tiny 五折 crop-sweep | 0.9054 | 0.50 | 0.7714 | 0.8879 | 0.8501 | TN 388 / FP 49 / FN 48 / TP 162 |
| 当前两模型正式方案 | 0.9151 | 0.399 | 0.8000 | 0.8856 | 0.8578 | TN 387 / FP 50 / FN 42 / TP 168 |
| 当前三模型优化方案 | 0.9162 | 0.453 | 0.7476 | 0.9291 | 0.8702 | TN 406 / FP 31 / FN 53 / TP 157 |
...
| 融合方式 | Small 权重 | AUC | 推荐阈值 | Sensitivity | Specificity | Accuracy | 结论 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
