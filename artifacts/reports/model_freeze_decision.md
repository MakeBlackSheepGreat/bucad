...
| BUSI TTA external evaluation | `artifacts/reports/busi_tta_eval.json` | AUC=0.8997; at threshold 0.25 sensitivity=0.8476, specificity=0.8078, accuracy=0.8207 |
| Release config | `configs/inference/demo.yml` | EfficientNetV2-S ensemble, flip TTA, and threshold 0.25 |

## Target Gap

- AUC target >= 0.75: PASS by +0.1497 on BUSI.
- Sensitivity target 0.85: NEAR PASS at threshold 0.25; current sensitivity is 0.8476, short by 0.0024.
- Specificity remains acceptable for demo/report framing at 0.8078 under the selected high-sensitivity threshold.
