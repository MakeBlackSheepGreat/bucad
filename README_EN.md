...
`v1a-quality-align` completed BUSBRA fold-1 screening with AUC `0.9192`, Accuracy `0.8480`, Sensitivity `0.7623`, Specificity `0.8893`, and F1 `0.7654`. Only Sensitivity reached the v1a fold-1 gate, so the route is stopped and archived; no five-fold expansion or external testing was run. See the [`Chinese screening report`](artifacts/reports/lesionext_lens_v1a_quality_align_fold1_zh.md) and [`English screening report`](artifacts/reports/lesionext_lens_v1a_quality_align_fold1_en.md).

`v1a-bg-consistency` completed the user-approved five-fold expansion and four locked external reviews. BUSBRA pooled OOF reached AUC `0.8982`, Accuracy `0.8400`, Sensitivity `0.7974`, Specificity `0.8604`, and F1 `0.7634`; Sensitivity increased by `0.0280` over frozen v1a, while AUC, Accuracy, Specificity, and F1 fell by `0.0167`, `0.0309`, `0.0592`, and `0.0308`. External AUC was `0.8985` on BUSI, `0.8914` on BUS-UCLM, `0.8123` on BUSI-WHU, and `0.8387` on TCIA BrEaST. The candidate remains supplementary, does not replace frozen v1a, and is excluded from the paper main table. See the [`Chinese five-fold and external report`](artifacts/reports/lesionext_lens_v1a_bg_consistency_5fold_zh.md), [`English five-fold and external report`](artifacts/reports/lesionext_lens_v1a_bg_consistency_5fold_en.md), [`JSON`](artifacts/reports/lesionext_lens_v1a_bg_consistency_5fold_summary.json), and [`CSV`](artifacts/reports/lesionext_lens_v1a_bg_consistency_5fold_metrics.csv).
...
`v1a-soft-evidence` completed BUSBRA fold-1 one-factor screening. The candidate changed only the training-time BBOX target by adding a limited perilesional ring. At fixed threshold `0.50`, it reached AUC `0.9246`, Accuracy `0.8613`, Sensitivity `0.7295`, Specificity `0.9249`, and F1 `0.7739`. AUC, Accuracy, Specificity, and F1 failed the frozen v1a fold-1 gate, so the route is stopped; no five-fold expansion or external review is run. See the [`Chinese report`](artifacts/reports/lesionext_lens_v1a_soft_evidence_fold1_zh.md) and [`English report`](artifacts/reports/lesionext_lens_v1a_soft_evidence_fold1_en.md).

`v1a-malignant-margin` completed BUSBRA fold-1 one-factor screening. The candidate added only a low-weight training-time malignant logit margin. At fixed threshold `0.50`, it reached AUC `0.9324`, Accuracy `0.8640`, Sensitivity `0.7623`, Specificity `0.9130`, and F1 `0.7848`. AUC and Sensitivity improved, while Accuracy, Specificity, and F1 fell below the v1a fold-1 gate; the route is stopped with no five-fold expansion or external review. See the [`Chinese report`](artifacts/reports/lesionext_lens_v1a_malignant_margin_fold1_zh.md) and [`English report`](artifacts/reports/lesionext_lens_v1a_malignant_margin_fold1_en.md).
...
`v1a-case-consistency` completed BUSBRA fold-1 one-factor screening. It added only same-`case_id` multi-view prediction consistency with weight `0.02` and temperature `0.5`. It reached AUC `0.9228`, Accuracy `0.8187`, Sensitivity `0.8689`, Specificity `0.7945`, Precision `0.6709`, and F1 `0.7571`. Sensitivity increased by `0.1394`, while AUC, Accuracy, Specificity, and F1 missed the frozen v1a fold-1 gate. The route is stopped with no five-fold or external evaluation. The checkpoint, configuration, training JSON, CSV, and bilingual reports are archived in [`v1a_case_consistency_fold1`](artifacts/reports/lesionext_archive/v1a_case_consistency_fold1/).

`v1a-align-lite` completed BUSBRA fold-1 one-factor screening. It changed only the training-time BBOX evidence-alignment weight from `0.25` to `0.10`, with all other frozen v1a protocol elements unchanged. It reached AUC `0.9060`, Accuracy `0.8080`, Sensitivity `0.8689`, Specificity `0.7787`, Precision `0.6543`, and F1 `0.7465`. Sensitivity increased by `0.1393`, while AUC, Accuracy, Specificity, Precision, and F1 decreased, so the five-metric promotion gate was not met. The route is stopped with no five-fold or external evaluation, and the candidate is archived in [`v1a_align_lite_fold1`](artifacts/reports/lesionext_archive/v1a_align_lite_fold1/). Full records are available in the [`Chinese report`](artifacts/reports/lesionext_lens_v1a_align_lite_fold1_zh.md), [`English report`](artifacts/reports/lesionext_lens_v1a_align_lite_fold1_en.md), [`JSON`](artifacts/reports/lesionext_lens_v1a_align_lite_fold1_summary.json), and [`CSV`](artifacts/reports/lesionext_lens_v1a_align_lite_fold1_metrics.csv).

`v1a-align-020` completed BUSBRA fold-1 one-factor screening. It changed only the alignment weight to `0.20` and reached AUC `0.9226`, Accuracy `0.8373`, Sensitivity `0.7705`, Specificity `0.8696`, Precision `0.7402`, and F1 `0.7550`. Sensitivity increased by `0.0410`, while the other main metrics fell below v1a. The route is stopped with no five-fold or external evaluation, and the candidate is archived in [`v1a_align_020_fold1`](artifacts/reports/lesionext_archive/v1a_align_020_fold1/). Full records are available in the [`Chinese report`](artifacts/reports/lesionext_lens_v1a_align_020_fold1_zh.md), [`English report`](artifacts/reports/lesionext_lens_v1a_align_020_fold1_en.md), [`JSON`](artifacts/reports/lesionext_lens_v1a_align_020_fold1_summary.json), and [`CSV`](artifacts/reports/lesionext_lens_v1a_align_020_fold1_metrics.csv).

`v1a-align-030` completed BUSBRA fold-1 one-factor screening. It changed only the alignment weight to `0.30` and reached AUC `0.9267`, Accuracy `0.7360`, Sensitivity `0.9426`, Specificity `0.6364`, Precision `0.5556`, and F1 `0.6991`. Sensitivity increased sharply, while benign false positives increased and Accuracy, Specificity, Precision, and F1 fell substantially. The route is stopped with no five-fold or external evaluation, and the candidate is archived in [`v1a_align_030_fold1`](artifacts/reports/lesionext_archive/v1a_align_030_fold1/). Full records are available in the [`Chinese report`](artifacts/reports/lesionext_lens_v1a_align_030_fold1_zh.md), [`English report`](artifacts/reports/lesionext_lens_v1a_align_030_fold1_en.md), [`JSON`](artifacts/reports/lesionext_lens_v1a_align_030_fold1_summary.json), and [`CSV`](artifacts/reports/lesionext_lens_v1a_align_030_fold1_metrics.csv).

The similarity review is complete. Shin, Kim, Wang, Xu, Lu, and Wei already cover weakly supervised localization, CAM localization, ROI refinement, region-aware learning, and joint segmentation-classification for breast ultrasound; arXiv:2511.15968 also reports a BI-RADS morphology-to-malignancy consistency bridge and directed four-dataset external transfer. The v1a manuscript should be positioned narrowly as “training-time BUSBRA BBOX evidence alignment with a single ConvNeXt-Tiny-derived classifier deployed without BBOX,” with no first-use claim for lesion-guided classification or joint localization-classification. See the [`Chinese literature review`](artifacts/reports/literature_similarity_review_zh.md) and [`English literature review`](artifacts/reports/literature_similarity_review_en.md).
