...
> Data boundary: BUSBRA is used for training, internal validation, OOF, model selection, threshold selection, and ROI parameter selection; BUSI is locked external evaluation only and must not be used for training or tuning.
