...
| 组合 | 权重 | AUC | Sens @0.50 | Spec @0.50 | Acc @0.50 | 最优阈值 | 最优 Sens | 最优 Spec | 最优 Acc | Youden J | Precision | F1-Score | 混淆矩阵 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
...
| 排名 | 组合 | 权重 | AUC | 最优阈值 | 最优 Sens | Precision | F1-Score | 最优 Spec | 最优 Acc | Youden J |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
