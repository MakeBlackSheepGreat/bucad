...
This checklist verifies that the project is ready to run the formal
...
| `artifacts/reports/comparison_results.json` | PARTIAL | Current file is a dry-run/smoke comparison, not the full model comparison |
...
- PENDING: Full model comparison must replace the current dry-run comparison report.
